...
bool PlaneLayer::init()
{
    ...
    closeItem->setPosition(Point(orgin.x + visibleSize.width - closeItem->getContentSize().width / 2,
                                 orgin.y + closeItem->getContentSize().height / 2));
